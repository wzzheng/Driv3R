...
from driv3r.loss import Regr3D_t, ConfLoss_t, Regr3D_t_ScaleShiftInv
from croco.utils.misc import NativeScalerWithGradNormCount as NativeScaler


def get_args_parser():
    parser = argparse.ArgumentParser('Driv3R training', add_help=False)
    ...
    parser.add_argument('--pretrained', default="checkpoints/spann3r.pth", help='path of a starting checkpoint')
    ...
    parser.add_argument('--test_dataset', required=True, type=str, help="testing set")
    ...
    parser.add_argument('--batch_size_test', default=1, type=int, help="Batch size per GPU")
    parser.add_argument('--accum_iter', default=1, type=int, help="Accumulate gradient iterations")
    parser.add_argument('--epochs', default=50, type=int, help="Maximum number of epochs for the scheduler")
    
    parser.add_argument('--weight_decay', type=float, default=0.05, help="weight decay")
    parser.add_argument('--lr', type=float, default=2e-5, metavar='LR', help='learning rate')
    parser.add_argument('--blr', type=float, default=6e-5, metavar='LR', help='base learning rate')
    parser.add_argument('--min_lr', type=float, default=1e-07, metavar='LR', help='lower lr bound for cyclic schedulers that hit 0')
    ...
    parser.add_argument('--save_freq', default=5, type=int, help='frequence to save checkpoint in checkpoint-last.pth')
...
def train_one_epoch(model: torch.nn.Module, flow_predictor, criterion: torch.nn.Module,
